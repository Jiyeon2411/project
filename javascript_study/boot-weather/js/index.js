(function () {
  ...
  /* 현재 위치 가져오기
  navigator.geolocation.getCurrentPosition(위치 정보 가져오기 성공할때, 
  위치 정보 가져오기 실패했을때);
    */
  ...
  function getWeather(lat, lon) {
    var urlAPI =
      "https://api.openweathermap.org/data/2.5/weather?appid=61f088e14e2823a4552f0782cb26db53&units=metric&lang=kr";
